class Solution:
    def findClosestNumber(self, nums: List[int]) -> int:
        ...
        for i in range(1,len(nums)):
            ...
            # we check wheather the abs value of the current number is less than the abs value of the number stored in the closest variable. If it is smaller then we update closest
            ...
            # we change the numbers to positive number and then check wheather they are equal if they are we update closest with the greater number
